...
Below is the original README file from the UAC HAR Dataset raw data, followed by the "Features Info" file describing features. This explains how data was collected, organized, named, and calculated in the original dataset. That dataset was then cleaned, tidied, made more redable, and modified to reflect mean and standard deviation values. A second dataset was produced to show the mean values for each activity/subject pairing. For details, see the Assignment Codebook.
...
For each record it is provided in raw data:
======================================
...
## Original Raw Data Feature Selection 
=================
